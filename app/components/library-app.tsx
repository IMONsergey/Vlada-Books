  ...
  return (
    <div className="view-stack">
      ...
      <section className="stats-grid">
        ...
        <StatCard label="Обложки найдены" value={meta.covers} note={`${Math.max(0, meta.works - meta.covers)} осталось проверить`} tone="sand" />
      </section>
      <section>
